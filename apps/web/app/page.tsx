        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col items-start gap-3">
            <button
              ...
              disabled={loading}
              className="inline-flex items-center gap-3 bg-[#22C55E] text-white px-8 py-4 rounded-2xl text-base font-bold shadow-lg shadow-[#22C55E]/20 hover:bg-[#16A34A] transition-all hover:-translate-y-0.5 active:scale-95 disabled:opacity-50"
            >
              <svg width="20" height="20" viewBox="0 0 24 24">
                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 01-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="currentColor" fillOpacity="0.8"/>
            ...
            <button
              onClick={handleGoogleLogin}
              disabled={loading}
              className="inline-flex items-center gap-3 bg-white text-slate-700 px-8 py-4 rounded-2xl text-base font-bold shadow-sm border border-slate-200 hover:bg-slate-50 transition-all hover:-translate-y-0.5 active:scale-95 disabled:opacity-50"
            >
              <svg width="20" height="20" viewBox="0 0 24 24">
